class Ghost {
    ...
    randomChangeDirection() {
        // if (this.getBlockX1() >= 9 && this.getBlockX1() <= 11 && this.getBlockY1() >= 10 && this.getBlockY1() <= 11) {
        //     this.defaultTimeChange = 10;
        //     console.log(this.defaultTimeChange)
        // }
        // else {
        //     this.defaultTimeChange = 1;
        // }
        if (this.time >= this.defaultTimeChange){
            let tempDirection = Math.floor(Math.random()*4)
            if (Math.abs(tempDirection - this.direction) != 2){
                this.nextDirection = tempDirection;
            }
            this.time = this.defaultTimeChange;
        }
        else {
            this.time++;
        }
